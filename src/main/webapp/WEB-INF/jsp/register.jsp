...
<html lang="ja">
    ...
    <body>
        ...
        <main class="main-wrapper card-wrapper">
            <div class="card">
                <h1>新規登録</h1>
                <form action="<c:url value='/register' />" method="post" class="login-register-form">
                    <input class="form-input" type="text" name="name" placeholder="ユーザー名" />
                    ...
                    <%-- <input class="form-input" type="password" placeholder="パスワードをもう一度入力" /> --%>
                    <button class="form-btn" type="submit">登録</button>
                </form>
                <p>または</p>
                <div class="google">Googleで続ける</div>
                <p>アカウントをお持ちですか？</p>
            </div>
            <a href="<c:url value='/login' />" class="link-btn">ログイン</a>
        </main>
    </body>
</html>
